...
"""
    dl_polygon(;kwargs...)
    dl_polygon(children::Any;kwargs...)
    dl_polygon(children_maker::Function;kwargs...)
...
- `positions` (Array of Array of Realss | Array of Array of Array of Realsss; required): An array of geographical points (lat, lon)
...
function dl_polygon(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("dl_polygon", "Polygon", "dash_leaflet", available_props, wild_props; kwargs...)
end

dl_polygon(children::Any; kwargs...) = dl_polygon(;kwargs..., children = children)
dl_polygon(children_maker::Function; kwargs...) = dl_polygon(children_maker(); kwargs...)
